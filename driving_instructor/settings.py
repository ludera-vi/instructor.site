"""
Настройки Django-проекта для сайта инструктора по вождению Ивана Гуничева.

Конфиденциальные параметры вынесены в .env (см. .env.example).

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
ИНСТРУКЦИЯ: Настройка PostgreSQL (для продакшена)
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

1. УСТАНОВКА PostgreSQL на сервере (Debian/Ubuntu):
...
2. СОЗДАНИЕ БАЗЫ ДАННЫХ И ПОЛЬЗОВАТЕЛЯ:
   ...
   -- Внутри psql:
   CREATE DATABASE driving_instructor ENCODING 'UTF8' LC_COLLATE 'ru_RU.UTF-8' LC_CTYPE 'ru_RU.UTF-8' TEMPLATE template0;
   CREATE USER drivinguser WITH PASSWORD 'ваш_надёжный_пароль';
   ...
   Если locale ru_RU.UTF-8 не установлена:
   sudo locale-gen ru_RU.UTF-8
   sudo update-locale

3. УСТАНОВКА ДРАЙВЕРА psycopg2:

   pip install psycopg2-binary
   # Или нативный (лучше для продакшена):
...
6. ПЕРЕНОС ДАННЫХ из SQLite в PostgreSQL (если есть данные):
...
7. НАСТРОЙКА Nginx + Gunicorn (пример):

   gunicorn driving_instructor.wsgi:application --workers 3 --bind 0.0.0.0:8000
